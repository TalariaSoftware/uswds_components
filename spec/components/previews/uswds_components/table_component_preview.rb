class UswdsComponents::TableComponentPreview < ViewComponent::Preview
  ...
  #
  # `stacked` and `staked_header` determine how the table looks on mobile-width
  # views.
  #
  ...
  def parameterized(borderless: false, striped: false, stacked: false, stacked_header: false, inner_html: DEFAULT_INNER_HTML)
